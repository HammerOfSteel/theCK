...
label call_to_adventure:
    ...
    if SI > 3:
        ...
        hide amelia_farewell_party_full
        show black
        window hide
        ...
        "Engage in conversation with another student (+1 SI)":
            ...
            menu:
                "Discuss academic interests (+1 AA)":
                    $ AA += 1
                    hide amelia_talking_student_full
                    show black
                    window hide
                    ...
                    hide amelia_discuss_academics_full
                    show black
                    window hide
                ...
                "Discuss personal backgrounds (+1 SI)":
                    ...
                    hide amelia_discuss_background_full
                    show black
                    window hide
        ...
        "Reflect quietly (+1 SD)":
            ...
            menu:
                ...
                "Observe passing landscapes (+1 SD)":
                    ...
                    hide amelia_observe_landscape_full
                    show black
                    window hide
    ...
    if AA > 3 and SD > 3:
        ...
        hide amelia_meet_professor_full
        show black
        window hide
    ...
    menu:
        "Explore the campus on her own (+1 SD)":
            $ SD += 1
            hide amelia_plymouth_campus_full
            show black
            window hide
            ...
            menu:
                "Visit the library (+1 AA)":
                    $ AA += 1
                    hide amelia_explore_campus_full
                    show black
                    window hide
                ...
                "Visit the psychology department (+1 SD)":
                    ...
                    hide amelia_psych_department_full
                    show black
                    window hide
        ...
        "Ask for directions (+1 SI)":
            ...
            menu:
                "Engage with a friendly student (+1 SI)":
                    $ SI += 1
                    hide amelia_ask_directions_full
                    show black
                    window hide
                    ...
                    hide amelia_friendly_student_full
                    show black
                    window hide
    ...
    if SD > 5:
        ...
        hide amelia_hidden_garden_full
        show black
        window hide
        ...
        "Decorate with academic posters (+1 AA)":
            ...
            menu:
                "Choose famous psychologists posters (+1 AA)":
                    $ AA += 1
                    hide amelia_academic_posters_full
                    show black
                    window hide
                    ...
                    n "Amelia hangs up posters of renowned psychologists, their faces and key theories decorating her walls."
                    hide amelia_psychologists_posters_full
                    show black
                    window hide
                ...
                "Choose inspiring quotes posters (+1 MH)":
                    ...
                    n "Amelia selects posters with uplifting messages and affirmations, creating a positive atmosphere in her room."
                    hide amelia_quotes_posters_full
                    show black
                    window hide
        ...
        "Decorate with personal photos (+1 SI)":
            ...
            menu:
                "Display family photos (+1 SI)":
                    $ SI += 1
                    hide amelia_personal_photos_full
                    show black
                    window hide
                    ...
                    n "Amelia lovingly arranges pictures of her parents, siblings, and extended family around her room."
                    hide amelia_family_photos_full
                    show black
                    window hide
                ...
                "Display travel memories (+1 SD)":
                    ...
                    n "Amelia creates a collage of images from various trips, a visual representation of her experiences and growth."
                    hide amelia_travel_memories_full
                    show black
                    window hide
    ...
    hide amelia_meet_roommate_full
    show black
    window hide
    ...
    if SI > 5 and MH > 5:
        ...
        hide amelia_roommate_confession_full
        show black
        window hide
    ...
    menu:
        "Attend an academic seminar (+1 AA)":
            $ AA += 1
            hide amelia_orientation_week_full
            show black
            window hide
            ...
            menu:
                "Ask a question (+1 AA)":
                    $ AA += 1
                    hide amelia_academic_seminar_full
                    show black
                    window hide
        ...
        "Attend a social mixer (+1 SI)":
            ...
            menu:
                ...
                "Volunteer for an event (+1 MC)":
                    ...
                    hide amelia_volunteer_event_full
                    show black
                    window hide
    ...
    if AA > 7 and SI > 7:
        ...
        hide amelia_dinner_with_faculty_full
        show black
        window hide
    ...
    menu:
        "Participate in class discussions (+1 AA)":
            $ AA += 1
            hide amelia_first_classes_full
            show black
            window hide
            ...
            menu:
                "Offer a unique perspective (+1 AA)":
                    $ AA += 1
                    hide amelia_class_discussion_full
                    show black
                    window hide
                    ...
                    hide amelia_unique_perspective_full
                    show black
                    window hide
                ...
                "Relate to personal experiences (+1 SD)":
                    ...
                    hide amelia_personal_experiences_full
                    show black
                    window hide
                ...
                "Observe and take notes (+1 SD)":
                    ...
                    menu:
                        "Focus on professor's lecture (+1 AA)":
                            $ AA += 1
                            hide amelia_observe_notes_full
                            show black
                            window hide
                            ...
                            hide amelia_professor_lecture_full
                            show black
                            window hide
                        ...
                        "Focus on classmates' reactions (+1 SD)":
                            ...
                            hide amelia_classmates_reactions_full
                            show black
                            window hide
    ...
    if AA > 10:
        ...
        hide amelia_professor_praise_full
        show black
        window hide
        ...
        "Attend a study group (+1 AA)":
            ...
            menu:
                "Lead a discussion (+1 AA)":
                    $ AA += 1
                    hide amelia_study_group_full
                    show black
                    window hide

                    show amelia_lead_discussion_full
                    n "In the study group, Amelia takes the initiative to start a discussion."
                    ...
                    n "The other students nod in agreement, impressed by Amelia's leadership."
                    hide amelia_lead_discussion_full
                    show black
                    window hide
                ...
                "Share study tips (+1 MC)":
                    ...
                    n "As the study group progresses, Amelia offers some advice."
                    ...
                    n "The other students appreciate Amelia's willingness to help."
                    hide amelia_share_study_tips_full
                    show black
                    window hide
        ...
        "Attend a social event (+1 SI)":
            ...
            menu:
                "Engage in meaningful conversations (+1 SI)":
                    $ SI += 1
                    hide amelia_social_event_full
                    show black
                    window hide

                    show amelia_meaningful_conversations_full
                    n "At the social event, Amelia strikes up conversations with various people."
                    n "She asks about their backgrounds, their interests, their hopes for the future."
                    a "Everyone has such a unique story. It's fascinating to see how our diverse experiences have brought us all here."
                    hide amelia_meaningful_conversations_full
                    show black
                    window hide
                ...
                "Try a new activity (+1 SD)":
                    ...
                    n "Amelia notices a group of students setting up for an impromptu theater game."
                    a "I've never tried improv before, but it looks like fun! Mind if I join in?"
                    n "The students welcome Amelia enthusiastically, and she finds herself laughing and creating alongside her new friends."
                    hide amelia_try_new_activity_full
                    show black
                    window hide
    ...
    menu:
        "Seek support from a friend (+1 SI)":
            $ SI += 1
            hide amelia_dorm_room_night_full
            show black
            window hide
            ...
            menu:
                "Open up about struggles (+1 MH)":
                    $ MH += 1
                    hide amelia_seek_support_full
                    show black
                    window hide

                    show amelia_open_up_struggles_full
                    n "Amelia calls up Ella."
                    ...
                    n "Amelia shares her struggles, and Ella listens with empathy and understanding."
                    hide amelia_open_up_struggles_full
                    show black
                    window hide
                ...
                "Ask for practical advice (+1 MC)":
                    ...
                    n "Amelia sends a message to her roommate Liz."
                    ...
                    hide amelia_practical_advice_full
                    show black
                    window hide
        ...
        "Tackle the challenge independently (+1 SD)":
            ...
            menu:
                "Create a detailed plan (+1 AA)":
                    $ AA += 1
                    hide amelia_tackle_challenge_full
                    show black
                    window hide

                    show amelia_detailed_plan_full
                    n "Amelia sits down at her desk and starts organizing her tasks."
                    a "Okay, let's prioritize. Upcoming deadlines first, then long-term projects. Block out study time, break times, and sleep."
                    n "She creates a color-coded schedule, feeling a sense of control return."
                    hide amelia_detailed_plan_full
                    show black
                    window hide
                ...
                "Practice self-care (+1 MH)":
                    ...
                    n "Amelia closes her eyes and takes a deep breath."
                    a "I need to remember to take care of myself. Yoga, meditation, journaling... these are all tools I can use."
                    n "She spends the next hour engaging in calming activities, feeling her stress melt away."
                    hide amelia_self_care_full
                    show black
                    window hide
    ...
    if MH > 10:
        ...
        $ MH += 2
        $ SD += 1
        n "Amelia makes a mental note to return to this garden whenever she needs a moment of peace."
        hide amelia_peace_garden_full
        show black
        window hide
        ...
        "Attend a lecture on a niche topic (+1 OK)":
            ...
            menu:
                "Dive into related research (+1 OK)":
                    $ OK += 1
                    hide amelia_niche_topic_full
                    show black
                    window hide

                    show amelia_related_research_full
                    n "After the lecture, Amelia's curiosity is piqued."
                    ...
                    n "She spends hours poring over obscure texts, fascinated by the depths of this esoteric knowledge."
                    hide amelia_related_research_full
                    show black
                    window hide
                ...
                "Discuss with the professor (+1 AA)":
                    ...
                    n "Amelia approaches the guest lecturer after the talk."
                    ...
                    n "The professor is impressed by Amelia's innovative thinking and engages her in a stimulating discussion."
                    hide amelia_discuss_professor_full
                    show black
                    window hide
        ...
        "Attend a lecture on a broad topic (+1 AA)":
            ...
            menu:
                "Consider potential specializations (+1 SD)":
                    $ SD += 1
                    hide amelia_broad_topic_full
                    show black
                    window hide

                    show amelia_potential_specializations_full
                    n "As the lecturer describes the various subfields, Amelia reflects on her own interests."
                    ...
                    n "She jots down notes, excited to delve deeper into the areas that resonate with her."
                    hide amelia_potential_specializations_full
                    show black
                    window hide
                ...
                "Connect topics to personal interests (+1 SD)":
                    ...
                    n "Amelia listens to the lecture, making connections to her own life."
                    ...
                    n "She feels a growing sense of self-awareness and a desire to apply these insights to her personal growth."
                    hide amelia_personal_interests_full
                    show black
                    window hide
    ...
    hide amelia_dorm_room_evening_full
    show black
    window hide
    ...
    hide amelia_motivated_full
    show black
    window hide

    show amelia_happy_full
    a "And you know what? I'm ready for it. Bring on the rest of this university adventure."
    n "Amelia has taken her first steps into the world of university and the study of the mind, but the true journey of transformation is just beginning."
    hide amelia_happy_full
    show black
    window hide
